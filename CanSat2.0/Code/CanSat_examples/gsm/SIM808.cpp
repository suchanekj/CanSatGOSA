...
const char smtp_user_name[ ] = "hatalomemail@gmail.com";   // SMTP user name
const char smtp_password[ ] = "Suchy na Mars!!!";    // SMTP password
...
#ifdef DEBUG
    DEBUG_SERIAL.println("la");
#endif
    if (answer == 0) {
        // power on pulse
#ifdef DEBUG
    DEBUG_SERIAL.println("lala");
#endif
